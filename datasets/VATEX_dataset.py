...
class VATEXDataset(Dataset):
    ...
    def __init__(self, config: Config, split_type='train', img_transforms=None):
        ...
        db_file = './VATEX/ref_captions.json'
        test_file = './VATEX/test_list.txt'
        train_file = './VATEX/train_list.txt'
    ...
    def _construct_all_train_pairs(self):
        ...
        for vid in self.train_vids:
            ...
            for cap in self.vid2caption[vid]:
                cap_ = cap_ + cap
            self.all_train_pairs.append([vid, cap_])
    ...
    def _construct_all_test_pairs(self):
        ...
        for vid in self.test_vids:
            ...
            for cap in self.vid2caption[vid]:
                cap_ = cap_ + cap
            self.all_test_pairs.append([vid, cap_])
